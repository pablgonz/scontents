...
%% 
%% Copyright (C) 2019-2021 by Pablo González L <pablgonz@educarchile.cl>
%% 
...
%%                                 scontents-code.tex.
%% 
\def\ScontentsFileDate{2021-05-22}%
\def\ScontentsFileVersion{1.9h}%
...
\file_if_exist:nTF { xparse-generic.tex }
