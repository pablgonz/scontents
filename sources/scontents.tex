...
%%                                 scontents-code.tex.
%% 
\def\ScontentsFileDate{2025-10-04}%
\def\ScontentsFileVersion{2.5}%
\def\ScontentsFileDescription{Stores LaTeX contents in memory or files}%
\input expl3-generic.tex
\ExplSyntaxOn
\tl_new:c { ver @ scontents . sty }
\tl_set:ce { ver @ scontents . sty } { \ScontentsFileDate\space
  v\ScontentsFileVersion\space \ScontentsFileDescription }
\iow_log:e { Package: ~ scontents ~ \tl_use:c { ver @ scontents . sty } }
