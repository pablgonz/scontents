...
%%                                 scontents-code.tex.
%% 
\def\ScontentsCoreFileDate{2025-05-05}%
\begingroup
  \catcode32=10
  \endlinechar=32
  \def\next{\endgroup}%
...
\bool_new:N      \l__scontents_print_mergesc_bool
\bool_set_true:N \l__scontents_print_mergesc_bool
...
\cs_new_protected:Npn \__scontents_typestored:nn #1 #2
  {
    ...
    \group_begin:
      ...
      \tl_replace_all:Nen \l__scontents_temp_tl { \c__scontents_hidden_space_str } { ^^J }
      \tl_log:N \l__scontents_temp_tl
      \tl_if_empty:NF \l__scontents_temp_tl
        {
          \bool_if:NT \l__scontents_print_mergesc_bool
            {
              \__scontents_typestored:N \l__scontents_temp_tl
            }
        }
      \__scontents_file_write_cmd:VV \l__scontents_fname_out_tl \l__scontents_temp_tl
      \use:e
  ...
  \cs_new_protected:Npn \__scontents_meaningsc:n #1
    {
      ...
      \tl_replace_all:Nen \l__scontents_temp_tl { \iow_char:N \^^J } { ~ }
      \tl_replace_all:Nen \l__scontents_temp_tl { \c__scontents_hidden_space_str } { ~ }
      \tl_log:N \l__scontents_temp_tl
      \tl_use:N \l__scontents_verb_font_tl
      \tl_replace_all:Nne \l__scontents_temp_tl { ^^I } { \__scontents_tabs_to_spaces: }
      \tl_if_empty:NF \l__scontents_temp_tl
        {
          \bool_if:NT \l__scontents_print_mergesc_bool
            {
...
\keys_define:nn { scontents / mergesc }
  {
    typestored .code:n =
      {
        \cs_set_eq:NN \__scontents_mergesc_set_cmd:nn \__scontents_typestored:nn
      },
    meaningsc  .code:n =
      {
        \cs_set_eq:NN \__scontents_mergesc_set_cmd:nn \__scontents_meaningsc:nn
      },
  }
\cs_new_protected:Npn \__scontents_mergesc_set_cmd:nn #1 #2
  {
...
\cs_new_protected:Npn \__scontents_mergesc_code:nn #1 #2
  {
    \group_begin:
      ...
      \exp_args:Ne \__scontents_mergesc_set_cmd:nn
