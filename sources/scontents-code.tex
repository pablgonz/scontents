...
%%                                 scontents-code.tex.
%% 
\def\ScontentsCoreFileDate{2025-05-07}%
\begingroup
  \catcode32=10
  \endlinechar=32
  \def\next{\endgroup}%
...
\keys_define:nn { scontents / typemeaning }
  {
    ...
    overwrite .meta:nn    = { scontents } { overwrite = #1 },
    overwrite .default:n  = true,
    print-cmd .bool_set:N = \l__scontents_print_mergesc_bool,
          ...
          \bool_if:NT \l__scontents_storing_bool
            {
              \tl_set:Nn \exp_not:N #1
                { \exp_args:NV \__scontents_remove_leading_nl:n \l__scontents_save_every_body_lines_tl }
            }
        }
    }
...
\cs_new_protected:Npn \__scontents_typestored:nn #1 #2
  {
    ...
    \group_begin:
      ...
      \tl_if_empty:NF \l__scontents_typestored_arg_tl
        {
          \bool_if:NT \l__scontents_print_mergesc_bool
            {
      ...
      \use:e
        {
    \group_end:
    \bool_if:NF \l__scontents_print_mergesc_bool { \__scontents_esphack: }
        }
  }
\group_begin:
  \char_set_catcode_active:N \^^M
