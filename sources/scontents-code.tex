...
\cs_new_protected:Npx \__scontents_analyse_nesting_generic:nn #1 #2
  {
    \cs_set_protected:Npn \exp_not:N \__scontents_analyse_nesting_generic:w ##1
      \c_backslash_str #1 scontents ##2 \exp_not:N \q__scontents_stop
      { \exp_not:N \__scontents_analyse_nesting_generic_process:nn {##1} {##2} }
    \exp_not:N \__scontents_analyse_nesting_generic:w #2
      \c_backslash_str #1 scontents \exp_not:N \q__scontents_mark \exp_not:N \q__scontents_stop
  }
