...
%%                                 scontents-code.tex.
%% 
\def\ScontentsCoreFileDate{2025-07-30}%
\begingroup
  \catcode32=10
  \endlinechar=32
  \def\next{\endgroup}%
...
\cs_generate_variant:Nn \__scontents_rescan_tokens:n { V, e }
...
\NewDocumentCommand \__scontents_Scontents_verb_arg:w { +v }
  {
    ...
    % \tl_replace_all:Nee \l__scontents_Scontents_arg_tl { \iow_char:N \^^M } { \iow_char:N \^^J }
...
\cs_new_protected:Npn \__scontents_typestored:nn #1 #2
  {
    ...
    \group_begin:
      ...
      % \tl_replace_all:Nen \l__scontents_typestored_arg_tl { \c__scontents_hidden_space_str } { ^^J }
